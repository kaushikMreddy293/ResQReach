...
import EarthquakeText from './guides/EarthquakeText';
import BeforeEarthquake from './guides/BeforeEarthquake';
import DuringEarthquake from './guides/DuringEarthquake';
import AfterEarthquake from './guides/AfterEarthquake';
import ProtectDuringEarthquake from './guides/ProtectDuringEarthquake';
...
// Earthquakes Guide Component
const EarthquakesGuide: React.FC = () => {
    ...
    const typingStyle = {
        ...
        whiteSpace: 'nowrap',
        animation: `typing 2s steps(40, end), blink-cursor .75s step-end infinite`,
    };
            ...
            <div style={{ maxHeight: 'calc(100vh - 100px)', overflowY: 'auto' }}>
                <div style={{ maxWidth: '100%', overflowY: 'auto' }}>
                    ...
                    <div style={{ fontFamily: 'Brygada, serif', ...currentStyles }}>
                        <EarthquakeText></EarthquakeText>
                        <h1 className="ml-4 text-2xl font-bold text my-4">Preparing Before an Earthquake</h1>
            
                        <div style={{ backgroundColor: 'initial', color: 'initial' }}>
                            <BeforeEarthquake></BeforeEarthquake>
                        </div>
                        <h1 className="ml-4 text-2xl font-bold text my-4">Stay Safe During</h1>
                        <div style={{ backgroundColor: 'initial', color: 'initial' }}>
                            <DuringEarthquake></DuringEarthquake>
                        </div>
                            <h1 className="ml-4 text-2xl font-bold text my-4">Protect Yourself During Earthquakes</h1>
                        <div style={{ backgroundColor: 'initial', color: 'initial' }}>
                            <ProtectDuringEarthquake></ProtectDuringEarthquake>
                        </div>
                        <h1 className="ml-4 text-2xl font-bold text my-4">Stay Safe After</h1>
                        <div style={{ backgroundColor: 'initial', color: 'initial' }}>
                            <AfterEarthquake></AfterEarthquake>
                        </div>
                    </div>
                    <button
...
export default EarthquakesGuide;
